...
public class TraineeDaoImpl implements TraineeDao {
    ...
    @Override
    public List<Trainee> listAll() throws Exception {
        return databaseQueryMetrics.trackQueryDuration(() -> {
    ...
    @Override
    public Optional<Trainee> findByUsername(String username) throws Exception {
        return databaseQueryMetrics.trackQueryDuration(() -> {
            Session session = sessionFactory.openSession();
            Transaction transaction = null;
    ...
    @Override
    public Optional<Trainee> findByUsernameAndPassword(String username, String password) throws Exception {
        return databaseQueryMetrics.trackQueryDuration(() -> {
            Session session = sessionFactory.openSession();
            Transaction transaction = null;
            Optional<Trainee> trainee = null;
    ...
    public List<Training> getTrainingByCriteria(String username, Date startDate, Date endDate, String
            trainerName, TrainingTypeEntity trainingType) throws Exception {
        return databaseQueryMetrics.trackQueryDuration(() -> {
            Session session = sessionFactory.openSession();
            Transaction transaction = null;
    ...
    @Override
    public List<Trainer> getTrainersNotAssignedToTrainee(String username) throws Exception {
        return databaseQueryMetrics.trackQueryDuration(() -> {
            Session session = sessionFactory.openSession();
            Transaction transaction = null;
    ...
    @Override
    public List<Trainer> getTrainersAssignedToTrainee(String username) throws Exception {
        return databaseQueryMetrics.trackQueryDuration(() -> {
            Session session = sessionFactory.openSession();
            Transaction transaction = null;
